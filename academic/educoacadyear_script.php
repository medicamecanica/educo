...
/**
 *      \file       educo/educoacadyear_script.php
 *		\ingroup    educo
...
// Examples for manipulating class educoacadyear_class
require_once(DOL_DOCUMENT_ROOT."/../educo/educoacadyear.class.php");
$myobject=new Educoacadyear($db);
...
$sql.= " FROM ".MAIN_DB_PREFIX."educoacadyear";
