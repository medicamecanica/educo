...
dol_include_once('/educo/class/educocgrado.class.php');
...
if (empty($reshook)) {
    ...
    include DOL_DOCUMENT_ROOT . '/educo/tpl/actions_groups.inc.php';
}
...
$help_url = '';
$title = $langs->trans('GroupsListTitle');
...
print '</td></tr></table>';
 include DOL_DOCUMENT_ROOT . '/educo/tpl/card_groups.inc.php';
print '</div>';
