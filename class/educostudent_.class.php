...
/**
 * \file    educo/educostudent.class.php
 * \ingroup educo
 ...
 * @see CommonObject
 */
class Educostudent extends CommonObject
{
	/**
	 * @var string Id to identify managed objects
	 */
	public $element = 'educostudent';
	/**
	 * @var string Name of table without prefix where object is stored
	 */
	public $table_element = 'educo_student';

	/**
	 * @var EducostudentLine[] Lines
	 */
	public $lines = array();
	...
	public function create(User $user, $notrigger = false)
	{
		...
		if (isset($this->fk_contact)) {
			 $this->fk_contact = trim($this->fk_contact);
		}
	...
	public function createFromClone($fromid)
	{
		...
		global $user;
		$error = 0;
		$object = new Educostudent($this->db);
