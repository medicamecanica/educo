...
/**
 *   	\file       educo/educocontactstudent_card.php
 *		\ingroup    educo
 *		\brief      This file is an example of a php page
 *					Initialy built by build_class_from_table on 2018-02-14 19:42
 */
...
dol_include_once('/educo/class/educocontactstudent.class.php');
...
$object = new Educocontactstudent($db);
...
$hookmanager->initHooks(array('educocontactstudent'));
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_contact").'</td><td><input class="flat" type="text" name="fk_contact" value="'.GETPOST('fk_contact').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_contact").'</td><td>'.$object->fk_contact.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_estudiante").'</td><td>'.$object->fk_estudiante.'</td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldentity").'</td><td>'.$object->entity.'</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('educocontactstudent'));
