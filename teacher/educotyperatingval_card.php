...
/**
 *   	\file       educo/educotyperatingval_card.php
 *		\ingroup    educo
...
$hookmanager->initHooks(array('educotyperatingval'));
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldlesser_than").'</td><td><input class="flat" type="text" name="lesser_than" value="'.GETPOST('lesser_than').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldphoto").'</td><td><input class="flat" type="text" name="photo" value="'.GETPOST('photo').'"></td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_rating").'</td><td><input class="flat" type="text" name="fk_rating" value="'.GETPOST('fk_rating').'"></td></tr>';
...
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldlesser_than").'</td><td>'.$object->lesser_than.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldphoto").'</td><td>'.$object->photo.'</td></tr>';
print '<tr><td class="fieldrequired">'.$langs->trans("Fieldfk_rating").'</td><td>'.$object->fk_rating.'</td></tr>';
	...
	//$linktoelem = $form->showLinkToObjectBlock($object, null, array('educotyperatingval'));
