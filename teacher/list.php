 ...
 *					Initialy built by build_class_from_table on 2018-03-02 17:25
 */
...
$search_fk_enrollement=GETPOST('search_fk_enrollement','int');
$search_fk_pensum=GETPOST('search_fk_pensum','int');
$search_fk_typeratingval=GETPOST('search_fk_typeratingval','int');
...
//'t.fk_enrollement'=>array('label'=>$langs->trans("Fieldfk_enrollement"), 'checked'=>1),
//'t.fk_pensum'=>array('label'=>$langs->trans("Fieldfk_pensum"), 'checked'=>1),
//'t.fk_typeratingval'=>array('label'=>$langs->trans("Fieldfk_typeratingval"), 'checked'=>1),
...
$search_import_key='';
$search_entity='';
$search_fk_enrollement='';
$search_fk_pensum='';
$search_fk_typeratingval='';
$search_fk_user='';
...
$sql.= " t.rowid,";
		...
		$sql .= " t.import_key,";
		$sql .= " t.entity,";
		$sql .= " t.fk_enrollement,";
		$sql .= " t.fk_pensum,";
		$sql .= " t.fk_typeratingval,";
		$sql .= " t.fk_user";
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."educo_qualification_extrafields as ef on (t.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
//$sql.= " WHERE u.entity IN (".getEntity('mytable',1).")";

if ($search_ref) $sql.= natural_search("ref",$search_ref);
if ($search_label) $sql.= natural_search("label",$search_label);
if ($search_datec) $sql.= natural_search("datec",$search_datec);
if ($search_tms) $sql.= natural_search("tms",$search_tms);
...
if ($search_period) $sql.= natural_search("period",$search_period);
...
if ($search_fk_enrollement) $sql.= natural_search("fk_enrollement",$search_fk_enrollement);
if ($search_fk_pensum) $sql.= natural_search("fk_pensum",$search_fk_pensum);
if ($search_fk_typeratingval) $sql.= natural_search("fk_typeratingval",$search_fk_typeratingval);
...
if ($user->rights->educo->supprimer) $arrayofmassactions['delete']=$langs->trans("Delete");
...
if (! empty($arrayfields['t.tms']['checked'])) print_liste_field_titre($arrayfields['t.tms']['label'],$_SERVER['PHP_SELF'],'t.tms','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.period']['checked'])) print_liste_field_titre($arrayfields['t.period']['label'],$_SERVER['PHP_SELF'],'t.period','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.fk_enrollement']['checked'])) print_liste_field_titre($arrayfields['t.fk_enrollement']['label'],$_SERVER['PHP_SELF'],'t.fk_enrollement','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.fk_pensum']['checked'])) print_liste_field_titre($arrayfields['t.fk_pensum']['label'],$_SERVER['PHP_SELF'],'t.fk_pensum','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.fk_typeratingval']['checked'])) print_liste_field_titre($arrayfields['t.fk_typeratingval']['label'],$_SERVER['PHP_SELF'],'t.fk_typeratingval','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.datec']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_datec" value="'.$search_datec.'" size="10"></td>';
if (! empty($arrayfields['t.tms']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_tms" value="'.$search_tms.'" size="10"></td>';
...
if (! empty($arrayfields['t.period']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_period" value="'.$search_period.'" size="10"></td>';
...
if (! empty($arrayfields['t.fk_enrollement']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_enrollement" value="'.$search_fk_enrollement.'" size="10"></td>';
if (! empty($arrayfields['t.fk_pensum']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_pensum" value="'.$search_fk_pensum.'" size="10"></td>';
if (! empty($arrayfields['t.fk_typeratingval']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_typeratingval" value="'.$search_fk_typeratingval.'" size="10"></td>';
