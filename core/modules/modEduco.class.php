 ...
 * Copyright (C) 2017       Andersson Paz      <npander@hotmail.comm>
 *
...
/**
 * 	\defgroup   educo     Module MyModule
 *  \brief      Example of a module descriptor.
 * 				Such a file must be copied into htdocs/educo/core/modules directory.
 *  \file       htdocs/educo/core/modules/modMyModule.class.php
 *  \ingroup    educo
 ...
 */
class modEduco extends DolibarrModules {
    ...
    public function __construct($db) {
        ...
        $this->numero = 500001;  // TODO Go on page http://wiki.dolibarr.org/index.php/List_of_modules_id to reserve id number for your module
        // Key text used to identify module (for permissions, menus, etc...)
        $this->rights_class = 'educo';
        ...
        $this->familyinfo = array('edu' => array('position' => '001', 'label' => $langs->trans("Education")));
        // Module position in the family
        $this->module_position = 500;
        // Module label (no space allowed), used if translation string 'ModuleXXXName' not found (where XXX is value of numeric property 'numero' of module)
        $this->name = preg_replace('/^mod/i', '', get_class($this));
        // Module description, used if translation string 'ModuleXXXDesc' not found (where XXX is value of numeric property 'numero' of module)
        $this->description = "Modulo para entidades educativas";
        ...
        $this->picto = 'ico@educo';

        // Defined all module parts (triggers, login, substitutions, menus, css, etc...)
        // for default path (eg: /educo/core/xxxxx) (0=disable, 1=enable)
        // for specific path of parts (eg: /educo/core/modules/barcode)
        // for specific css file (eg: /educo/css/educo.css.php)
        ...
        //							'css' => array('/educo/css/educo.css.php'),	// Set this to relative path of css file if module has its own css file
        //							'js' => array('/educo/js/educo.js'),          // Set this to relative path of js file if module must load a js on all pages
        ...
        $this->langfiles = array("educo@educo");
        ...
        // Example: $this->tabs = array('objecttype:+tabname1:Title1:educo@educo:$user->rights->educo->read:/educo/mynewtab1.php?id=__ID__',  					// To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:SUBSTITUTION_Title2:educo@educo:$user->rights->othermodule->read:/educo/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2. Label will be result of calling all substitution functions on 'Title2' key.
        ...
        // Dictionaries
        if (!isset($conf->educo->enabled)) {
            $conf->educo = new stdClass();
            $conf->educo->enabled = 0;
        }
        ...
        // Example:
        //$this->boxes=array(
        //    0=>array('file'=>'myboxa.php@educo','note'=>'','enabledbydefaulton'=>'Home'),
        //    1=>array('file'=>'myboxb.php@educo','note'=>''),
        //    2=>array('file'=>'myboxc.php@educo','note'=>'')
        //);
        // Cronjobs
        ...
        $this->rights[$r][4] = 'read';    // In php code, permission will be checked by test if ($user->rights->educo->level1->level2)
        ...
        $this->rights[$r][3] = 1;      // Permission by default for new user (0/1)
        $this->rights[$r][4] = 'delete';    // In php code, permission will be checked by test if ($user->rights->educo->level1->level2)
        $this->rights[$r][5] = '';        // In php code, permission will be checked by test if ($user->rights->educo->level1->level2)
        ...
        $this->menu[$r] = array('fk_menu' => '', // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
            ...
            'position' => 100,
            'enabled' => '$conf->educo->enabled', // Define condition to show or hide menu entry. Use '$conf->educo->enabled' if entry must be visible if module is enabled.
            'perms' => '1', // Use 'perms'=>'$user->rights->educo->level1->level2' if you want your menu with a permission rules
            'target' => '',
        ...
        $r++;
        // Example to declare a Left Menu entry into an existing Top menu entry:
        $this->menu[$r] = array('fk_menu' => 'fk_mainmenu=educo,fk_leftmenu=inst', // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
            'type' => 'left', // This is a Left menu entry
            'titre' => 'NewAcademicYear',
            'mainmenu' => 'educo',
            'leftmenu' => 'neway',
            'url' => '/educo/academic/card.php?action=create',
            'langs' => 'educo@educo', // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
            'position' => 1000 + $r,
            'enabled' => '$conf->educo->enabled', // Define condition to show or hide menu entry. Use '$conf->educo->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
        ...
        $this->menu[$r] = array('fk_menu' => 'fk_mainmenu=educo,fk_leftmenu=inst', // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
            'type' => 'left', // This is a Left menu entry
            'titre' => 'ListAcademciYear',
            'mainmenu' => 'educo',
            'leftmenu' => 'listay',
            'url' => '/educo/academic/list.php',
            'langs' => 'educo@educo', // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
            'position' => 1000 + $r,
            'enabled' => '$conf->educo->enabled', // Define condition to show or hide menu entry. Use '$conf->educo->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
            'perms' => '$user->rights->educo->write', // Use 'perms'=>'$user->rights->educo->level1->level2' if you want your menu with a permission rules
        ...
        $r++;
        // Example to declare a Left Menu entry into an existing Top menu entry:
        $this->menu[$r] = array('fk_menu' => 'fk_mainmenu=educo,fk_leftmenu=estudent', // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
            'type' => 'left', // This is a Left menu entry
            'titre' => 'Nuevo Estudiante',
            'mainmenu' => 'educo',
            'leftmenu' => 'new_estudent',
            'url' => '/educo/student/card.php?action=create',
            'langs' => 'educo@educo', // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
            'position' => 1000 + $r,
            'enabled' => '$conf->educo->enabled', // Define condition to show or hide menu entry. Use '$conf->educo->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
            'perms' => '$user->rights->educo->write', // Use 'perms'=>'$user->rights->educo->level1->level2' if you want your menu with a permission rules
        ...
        $this->menu[$r] = array('fk_menu' => 'fk_mainmenu=educo,fk_leftmenu=estudent', // '' if this is a top menu. For left menu, use 'fk_mainmenu=xxx' or 'fk_mainmenu=xxx,fk_leftmenu=yyy' where xxx is mainmenucode and yyy is a leftmenucode
            ...
            'titre' => 'Listado',
            'mainmenu' => 'educo',
            'leftmenu' => 'list_estudent',
            'url' => '/educo/student/list.php',
            'langs' => 'educo@educo', // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
            'position' => 1000 + $r,
            'enabled' => '$conf->educo->enabled', // Define condition to show or hide menu entry. Use '$conf->educo->enabled' if entry must be visible if module is enabled. Use '$leftmenu==\'system\'' to show if leftmenu system is selected.
            'perms' => '$user->rights->educo->read', // Use 'perms'=>'$user->rights->educo->level1->level2' if you want your menu with a permission rules
        ...
        // $this->export_permission[$r]=array(array("educo","level1","level2"));
