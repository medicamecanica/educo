...
't.fk_contact'=>array('label'=>$langs->trans("Fieldfk_contact"), 'checked'=>1),
...
if (is_array($extrafields->attribute_label) && count($extrafields->attribute_label)) $sql.= " LEFT JOIN ".MAIN_DB_PREFIX."educo_student_extrafields as ef on (t.rowid = ef.fk_object)";
$sql.= " WHERE 1 = 1";
...
if ($search_doc_type) $sql.= natural_search("doc_type",$search_doc_type);
if ($search_document) $sql.= natural_search("document",$search_document);
if ($search_entity) $sql.= natural_search("entity",$search_entity);
if ($search_fk_contact) $sql.= natural_search("fk_contact",$search_fk_contact);
...
if (! empty($arrayfields['t.doc_type']['checked'])) print_liste_field_titre($arrayfields['t.doc_type']['label'],$_SERVER['PHP_SELF'],'t.doc_type','',$params,'',$sortfield,$sortorder);
if (! empty($arrayfields['t.document']['checked'])) print_liste_field_titre($arrayfields['t.document']['label'],$_SERVER['PHP_SELF'],'t.document','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.fk_contact']['checked'])) print_liste_field_titre($arrayfields['t.fk_contact']['label'],$_SERVER['PHP_SELF'],'t.fk_contact','',$params,'',$sortfield,$sortorder);
...
if (! empty($arrayfields['t.doc_type']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_doc_type" value="'.$search_doc_type.'" size="10"></td>';
if (! empty($arrayfields['t.document']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_document" value="'.$search_document.'" size="10"></td>';
...
if (! empty($arrayfields['t.fk_contact']['checked'])) print '<td class="liste_titre"><input type="text" class="flat" name="search_fk_contact" value="'.$search_fk_contact.'" size="10"></td>';
